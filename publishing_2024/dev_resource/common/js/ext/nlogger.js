...
Nethru.Settings = function() {
    ...
    if(broswerInfo.indexOf("COMPANY")>-1){
        NTH_SERVICE_ID = "webview." + NTH_SERVICE_ID;
    }
	
    // 로깅서버 URL
    var NTH_LOGGING_URL_BASE_HTTP = "https://weblog.nhcapital.co.kr:9443/logging";
    var NTH_LOGGING_URL_BASE_HTTPS = "https://weblog.nhcapital.co.kr:9443/logging";
    ...
    // 유입
    var NTH_INFLOW_LANDING_URL = "61.33.35.142:8000/download/ljk/b.html";
    var NTH_INFLOW_FROM = "inflow";
    var NTH_INFLOW_FROM_PARAM = "nth_inflow";
    var NTH_INFLOW_EXPIRE = 30;
    ...
    return {
        ...
        inflowLandingUrl : NTH_INFLOW_LANDING_URL,
        inflowFromLoggingKey : NTH_INFLOW_FROM,
        inflowFromParamKey : NTH_INFLOW_FROM_PARAM,
        inflowExpire : NTH_INFLOW_EXPIRE,
...
Nethru.Util = function() {
    ...
    _this.configure = function(settings) {
        ...
        var keys = {
            ...
            nth_inflow_landing_url: "inflowLandingUrl",
            nth_inflow_from: "inflowFromLoggingKey",
            nth_inflow_from_param: "inflowFromParamKey",
            nth_inflow_expire: "inflowExpire",
            nth_timeout: "timeout"
...
Nethru.BrowserInfo = function() {
    ...
    _this.getAutoLoggingParameters = function () {
        ...
        var key = Nethru.Settings.inflowFromLoggingKey;
...
Nethru.Logger = function() {
    ...
    _this.updateAdInflowFromUrl = function() {
        var settings = Nethru.Settings;
        if(location.href.indexOf(settings.inflowLandingUrl) < 0) return;

        var value = Nethru.BrowserInfo.getQueryStringValueByName(settings.inflowFromParamKey);
        if(!value) return;

        _this.setCookie(settings.inflowFromLoggingKey, value, settings.inflowExpire);
    };
